...
class ActorCritic:
    def __init__(self):
        ...
        self.optimizer = optim.Adam(model.parameters(), lr = 0.001)  # 딥러닝 최적화 방식
...
class PolicyGradient(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(2, 256)  # 입력 state 2개
        self.fc2 = nn.Linear(256, 8)  # POLICY_NETWORK

        model = nn.Linear(1, 1)

        self.optimizer = optim.Adam(model.parameters(), lr = 0.0003)  # 딥러닝 최적화 방식
    ...
    for n in range(10000):
        ...
        while not end_episode() and score > -5000000:
            ...
            if me.x == 600 and me.y == 400 and num == 0:
                    ...
                    out = pi(torch.tensor(state).float())
                    num += 1
            else:
